...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Kawaiita', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Kawaiita', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://kawaiita.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Kawaiita', // 网站关键词 英文逗号隔开
